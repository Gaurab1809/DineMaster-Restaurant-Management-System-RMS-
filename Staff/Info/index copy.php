    ...
    <nav>
        <div id="nav-wrapper">
            <ul id="nav-list">
                ...
                <li><a href="http://localhost/RMS/Staff/index.php" class="active"><span class="material-icons">group</span>Staff</a></li>
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                -->
                    ...
                    <a href="http://localhost/FRMS/Staff/Role/index.php">
